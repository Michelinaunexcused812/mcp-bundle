...
Requires: `bash` 4+, `jq`. Tests validate manifest parsing, required fields, validation rules, workflow/action structure, skill content, and example presence. All 141 tests must pass before committing.
